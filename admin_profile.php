...
if(isset($_POST[submit]))
{
	...
	{
			$sql ="UPDATE admin SET loginid='$_POST[loginid]',status='$_POST[select]' WHERE loginid='$_SESSION[adminid]'";
	...
	{
	$sql ="INSERT INTO admin(loginid,status) values('$_POST[loginid]','$_POST[select]')";
	if($qsql = mysqli_query($con,$sql))
	{
